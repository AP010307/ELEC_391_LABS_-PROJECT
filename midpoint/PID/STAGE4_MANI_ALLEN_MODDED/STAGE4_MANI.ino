...
const float FALL_LIMIT  = 40.0;
const float I_MAX       = 30.0;
const float DERIV_TAU   = 0.02;

// ===== drive command biases (set by handleCommand) =====
const float FWD_LEAN_FWD = 1.6;
const float FWD_LEAN_BACK = 0.4;
const float TURN     = 6.0;        // differential bias for steering (tune)
...
void setup(){
  ...
  pid.Kp=10.5; pid.Ki=40.0; pid.Kd=1.7; pid.tau=DERIV_TAU;
